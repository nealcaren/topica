...
| `ThreadTM` | `src/thread_tm.rs` | `src/python/thread_tm.rs` | variational EM: logistic-normal per-doc bound (crate::ctm) + Gaussian tree-field belief propagation (crate::tree_field) | default | `tests/test_thread_tm.py` |
