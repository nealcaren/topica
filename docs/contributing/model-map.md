...
| `ReplyTM` | `src/reply_tm.rs` | `src/python/reply_tm.rs` | variational EM: logistic-normal per-doc bound (crate::ctm) + Gaussian tree-field belief propagation (crate::tree_field) | default | `tests/test_reply_tm.py` |
