...
| `ThreadTM` | `python/topica/threads.py` | `python/topica/threads.py` | base model fit (LDA Gibbs / STM / CTM) + Dirichlet thread-context shrinkage with pseudo-counts chosen by held-out likelihood | default | `tests/test_threads.py` |
