...
REGISTRY: dict[str, ModelInfo] = {
    m.name: m for m in [
        ...
        _m("ReplyTM", "covariates", ("text", "links"), "variational", "seed-reproducible", (),
...
IMPL: dict[str, ImplInfo] = {
    ...
    "ReplyTM": _i("src/reply_tm.rs", "src/python/reply_tm.rs", "variational EM: logistic-normal per-doc bound (crate::ctm) + Gaussian tree-field belief propagation (crate::tree_field)", "", "tests/test_reply_tm.py"),
