...
REGISTRY: dict[str, ModelInfo] = {
    m.name: m for m in [
        ...
        _m("ThreadTM", "covariates", ("text", "links"), "variational", "seed-reproducible", (),
           ...
           "guides/models.md#threadtm", experimental=True),
        # ---- Guided & supervised -------------------------------------------
...
IMPL: dict[str, ImplInfo] = {
    ...
    "ThreadTM": _i("src/thread_tm.rs", "src/python/thread_tm.rs", "variational EM: logistic-normal per-doc bound (crate::ctm) + Gaussian tree-field belief propagation (crate::tree_field)", "", "tests/test_thread_tm.py"),
