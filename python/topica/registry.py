...
REGISTRY: dict[str, ModelInfo] = {
    m.name: m for m in [
        ...
        _m("Top2Vec", "embedding", ("text", "embeddings"), "clustering", "seed-reproducible", (),
           ...
           "guides/embedding.md"),
        _m("MechanisticLDA", "embedding", ("text", "embeddings"), "gibbs", "seed-reproducible", ("mechanistic",),
           "mLDA (Zheng et al. 2025): collapsed-Gibbs LDA over thresholded sparse-autoencoder feature counts instead of words, so topics are distributions over model-internal directions you can steer, not vocabulary.",
           "guides/models.md#mechanisticlda", experimental=True),
        _m("MechanisticBERTopic", "embedding", ("text", "embeddings"), "clustering", "seed-reproducible", ("mechanistic",),
           "mBERTopic (Zheng et al. 2025): BERTopic run twice-over on sparse-autoencoder features — documents embedded by weighting SAE decoder directions, topics named by class-based TF-IDF over features.",
           "guides/models.md#mechanisticbertopic", experimental=True),
...
IMPL: dict[str, ImplInfo] = {
    ...
    "MechanisticLDA": _i("python/topica/mtm.py", "", "SAE featurization (Python) over the SparseLDA collapsed-Gibbs core", "", "tests/test_mtm.py"),
