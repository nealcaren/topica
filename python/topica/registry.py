...
REGISTRY: dict[str, ModelInfo] = {
    m.name: m for m in [
        ...
        _m("Scholar", "covariates", ("text", "metadata"), "vae", "seed-reproducible", (),
           "SCHOLAR (Card et al. 2018): a ProdLDA VAE whose topic-prevalence prior is shifted by document covariates (neural STM prevalence).",
