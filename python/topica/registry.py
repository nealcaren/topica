...
IMPL: dict[str, ImplInfo] = {
    ...
    "ThreadTM": _i("python/topica/threads.py", "python/topica/threads.py", "base model fit (LDA Gibbs / STM / CTM) + Dirichlet thread-context shrinkage with pseudo-counts chosen by held-out likelihood", "", "tests/test_threads.py"),
    "TreeFieldTM": _i("src/thread_tm.rs", "src/python/thread_tm.rs", "variational EM: logistic-normal per-doc bound (crate::ctm) + Gaussian tree-field belief propagation (crate::tree_field)", "", "tests/test_tree_field_tm.py"),
