...
REGISTRY: dict[str, ModelInfo] = {
    m.name: m for m in [
        ...
        _m("ContextualSTM", "covariates", ("text", "embeddings", "metadata"), "vae", "seed-reproducible", (),
           "Contextual STM (experimental): CombinedTM/ZeroShotTM's sentence-embedding encoder with SCHOLAR's prevalence-covariate prior — covariate effects on topic prevalence estimated inside the fit for an embedding-based model.",
           "guides/models.md#contextualstm", experimental=True),
...
IMPL: dict[str, ImplInfo] = {
    ...
    "ContextualSTM": _i("src/contextual_stm.rs", "src/python/contextual_stm.rs", "contextual ProdLDA VAE + covariate prior (prodlda.rs)", "", "tests/test_contextual_stm.py"),
