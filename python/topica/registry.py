...
REGISTRY: dict[str, ModelInfo] = {
    m.name: m for m in [
        ...
        _m("IdealPointTM", "embedding", ("text", "embeddings"), "variational", "seed-reproducible", (),
           "Embedded topic model with a latent ideal-point head: each author gets a low-dimensional position that shifts within-topic word choice, with a per-topic discrimination. The unsupervised, latent-trait twin of the STM content covariate; the embedding-native generalization of Wordfish.",
           "guides/models.md#idealpointtm", experimental=True),
        _m("Wordfish", "general-purpose", ("text",), "em", "bit-exact", (),
           ...
           "guides/models.md#wordfish", experimental=True),
        _m("IdealPointLDA", "general-purpose", ("text",), "variational", "seed-reproducible", (),
           "The count-based twin of IdealPointTM: a topic model whose per-topic word distributions are displaced by a latent author ideal point, parameterized directly over the vocabulary (no embeddings). Wordfish with topics.",
           "guides/models.md#idealpointlda", experimental=True),
        _m("SentenceIdealTM", "embedding", ("text", "embeddings"), "em", "seed-reproducible", (),
           "Continuous ideal-point topic model over sentence/document embeddings: topics are Gaussian clusters whose centroids are displaced by a latent author position. The embedding-native analog of IdealPointTM, fit by EM.",
           "guides/models.md#sentenceidealtm", experimental=True),
        _m("TBIP", "general-purpose", ("text",), "variational", "seed-reproducible", (),
           ...
           "guides/models.md#tbip", experimental=True),
