...
(keyATM), and covariate-driven sentiment (STS). For the spectral-initialized
...
collapsed-Gibbs models (LDA, DMR) each engine initializes at random, so as
Section~\ref{sec:validation} notes the agreement is statistical---the dominant
