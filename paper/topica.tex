...
DTM) the agreement is statistical, as Section~\ref{sec:validation} notes: the
...
the nonparametric HDP the headline result is instead that both engines infer nearly
the same topic count (about thirty) without being told it.
...
TopicGPT are validated in Section~\ref{sec:validation} and \code{parity/} against
