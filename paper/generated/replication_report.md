...
- Date: 2026-07-13
- topica: 0.34.0
- Machine: macOS-26.5.2-arm64-arm-64bit-Mach-O, 14 cores (arm)
- Toolchains: Rscript=yes, R:stm=yes, R:keyATM=yes, java=yes, mallet=yes

> Scope: this is a strict refresh of Section 5 validation at topica 0.34.0.
> The retained Section 6 benchmark outputs below were not regenerated by this
> scoped run; they remain machine-stamped performance provenance from the prior
> archival benchmark run.
...
|---|---|---|---|
| stm_prevalence | 5 | OK | 446s |
| stm_content | 5 | OK | 1s |
| keyatm | 5 | OK | 177s |
| sts | 5 | OK | 641s |
| mallet_lda | 5 | OK | 2s |
| weights_ame | 5 | OK | 1s |
| validation_appendix | 5 | OK | 1092s |
